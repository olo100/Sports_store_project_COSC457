package com.sportsstore.ui;                                                   
  ...
  public class MainFrame extends JFrame {
      ...
      public MainFrame(LoginDialog.Account account, Runnable onLogout) {        
          ...
          tabs.addTab("Stores",           new                                   
  EntityCrudPanel(SchemaCatalog.store(), account));                             
          tabs.addTab("Departments",      new                                   
  EntityCrudPanel(SchemaCatalog.department(), account));                        
          tabs.addTab("Employees",        new
  EntityCrudPanel(SchemaCatalog.employee(), account));                          
          tabs.addTab("Categories",       new
  EntityCrudPanel(SchemaCatalog.category(), account));                          
          tabs.addTab("Products",         new
  EntityCrudPanel(SchemaCatalog.product(), account));                           
          tabs.addTab("Customers",        new
  EntityCrudPanel(SchemaCatalog.customer(), account));                          
          tabs.addTab("Inventory",        new
  EntityCrudPanel(SchemaCatalog.inventory(), account));                         
          tabs.addTab("Sales",            new
  EntityCrudPanel(SchemaCatalog.sale(), account));                              
          tabs.addTab("Sale Items",       new
  EntityCrudPanel(SchemaCatalog.saleItem(), account));                          
          tabs.addTab("Vendor Contracts", new
  EntityCrudPanel(SchemaCatalog.vendorContract(), account));                    
          ...
          JLabel footer = new JLabel("  Connected to " +                        
  ...
  UiTheme.BORDER));                                                             
      ...
      private JPanel buildHeader() {
          ...
          JLabel badge = new JLabel(account.role + "  |  Logout",
